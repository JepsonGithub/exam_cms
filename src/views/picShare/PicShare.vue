  ...
  <div class="'picshare'">
    <div class="tit" ref="tit">
      <ul class="tit_content" ref="tit_content">
        <li :class="{ tit_item: true, active_item: item.id == $route.params.cateid}" ref="tit_item" v-for='(item, index) in itemList' :key="index"><router-link :to="'/home/picShare/'+item.id">{{ item.title }}</router-link></li>
      </ul>
    </div>
    <div class="picinfo">
